    ...
    f = (function (a, b) {
      var d = "datetimepicker",
        ...
        q = {
          ...
          btns: { showToday: !1, showClear: !1, showClose: !1 },
        ...
        r = (function () {
          ...
          return (
            ...
            (r.prototype.btns = function (b) {
              if (0 === arguments.length)
                return a.extend({}, this._options.btns);
              if (!(b instanceof Object))
                throw new TypeError("btns() expects parameter to be an Object");
              if (
                (a.extend(this._options.btns, b),
                "boolean" != typeof this._options.btns.showToday)
              )
                throw new TypeError(
                  "btns.showToday expects a boolean parameter"
                );
              if ("boolean" != typeof this._options.btns.showClear)
                throw new TypeError(
                  "btns.showClear expects a boolean parameter"
                );
              if ("boolean" != typeof this._options.btns.showClose)
                throw new TypeError(
                  "btns.showClose expects a boolean parameter"
                );
              this.widget && (this.hide(), this.show());
            }),
        ...
        return (
          ...
          (k.prototype._init = function () {
            if (this._element.hasClass("input-group")) {
              var a = this._element.find(".datepickerbtn");
              0 === a.length
          ...
          (k.prototype._getTimePickerMainTemplate = function () {
            ...
            return (
              ...
              this.use24Hours ||
                ...
                b.append(
                  e("<td>").append(
                    e("<btn>").addClass("btn btn-primary").attr({
