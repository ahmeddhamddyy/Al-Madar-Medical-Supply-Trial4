...
+(function () {
  ...
  var DateTimePicker = (function ($, moment) {
    ...
    var DateTimePicker = (function () {
      ...
      DateTimePicker.prototype._setValue = function _setValue(
        targetMoment,
        index
      ) {
      ...
      DateTimePicker.prototype._isInDisabledDates = function _isInDisabledDates(
        testDate
      ) {
        return (
      ...
      DateTimePicker.prototype._isInEnabledDates = function _isInEnabledDates(
        testDate
      ) {
        return (
      ...
      DateTimePicker.prototype._isInDisabledHours = function _isInDisabledHours(
        testDate
      ) {
        return this._options.disabledHours[testDate.format("H")] === true;
      };

      DateTimePicker.prototype._isInEnabledHours = function _isInEnabledHours(
        testDate
      ) {
        return this._options.enabledHours[testDate.format("H")] === true;
      };

      DateTimePicker.prototype._isValid = function _isValid(
        targetMoment,
        granularity
      ) {
      ...
      DateTimePicker.prototype._parseInputDate = function _parseInputDate(
        inputDate
      ) {
      ...
      DateTimePicker.prototype._indexGivenDates = function _indexGivenDates(
        givenDatesArray
      ) {
      ...
      DateTimePicker.prototype._indexGivenHours = function _indexGivenHours(
        givenHoursArray
      ) {
      ...
      DateTimePicker.prototype._initFormatting = function _initFormatting() {
        ...
        this.actualFormat = format.replace(
          ...
          function (formatInput) {
            return (
              self._dates[0].localeData().longDateFormat(formatInput) ||
              formatInput
      ...
      DateTimePicker.prototype._getLastPickedDate =
        function _getLastPickedDate() {
          return this._dates[this._getLastPickedDateIndex()];
        };

      DateTimePicker.prototype._getLastPickedDateIndex =
      ...
      DateTimePicker.prototype.ignoreReadonly = function ignoreReadonly(
        _ignoreReadonly
      ) {
      ...
      DateTimePicker.prototype.dayViewHeaderFormat =
      ...
      DateTimePicker.prototype.defaultDate = function defaultDate(
        _defaultDate
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.locale = function locale(_locale) {
        ...
        if (!moment.localeData(_locale)) {
          throw new TypeError(
            "locale() locale " + _locale + " is not loaded from moment locales!"
          );
        }
      ...
      DateTimePicker.prototype.calendarWeeks = function calendarWeeks(
        _calendarWeeks
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.btns = function btns(_btns) {
        if (arguments.length === 0) {
          return $.extend({}, this._options.btns);
        }

        if (!(_btns instanceof Object)) {
          throw new TypeError("btns() expects parameter to be an Object");
        }

        $.extend(this._options.btns, _btns);

        if (typeof this._options.btns.showToday !== "boolean") {
          throw new TypeError("btns.showToday expects a boolean parameter");
        }
        if (typeof this._options.btns.showClear !== "boolean") {
          throw new TypeError("btns.showClear expects a boolean parameter");
        }
        if (typeof this._options.btns.showClose !== "boolean") {
          throw new TypeError("btns.showClose expects a boolean parameter");
        }
      ...
      DateTimePicker.prototype.focusOnShow = function focusOnShow(
        _focusOnShow
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.allowInputToggle = function allowInputToggle(
        _allowInputToggle
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.keepInvalid = function keepInvalid(
        _keepInvalid
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.datepickerInput = function datepickerInput(
        _datepickerInput
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.parseInputDate = function parseInputDate(
        _parseInputDate2
      ) {
        if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.disabledTimeIntervals =
        function disabledTimeIntervals(_disabledTimeIntervals) {
          if (arguments.length === 0) {
      ...
      DateTimePicker.prototype.allowMultidate = function allowMultidate(
        _allowMultidate
      ) {
      ...
      DateTimePicker.prototype.multidateSeparator = function multidateSeparator(
        ...
        if (
          typeof _multidateSeparator !== "string" ||
          _multidateSeparator.length > 1
        ) {
          throw new TypeError(
    ...
    var TempusDominusBootstrap4 = (function (_DateTimePicker) {
      ...
      function TempusDominusBootstrap4(element, options) {
        ...
        var _this = _possibleConstructorReturn(
          this,
          _DateTimePicker.call(this, element, options)
        );
      ...
      TempusDominusBootstrap4.prototype._init = function _init() {
        if (this._element.hasClass("input-group")) {
          var datepickerbtn = this._element.find(".datepickerbtn");
          if (datepickerbtn.length === 0) {
            this.component = this._element.find(
              '[data-toggle="datetimepicker"]'
            );
          } else {
            this.component = datepickerbtn;
          }
        }
      };

      TempusDominusBootstrap4.prototype._getDatePickerTemplate =
      ...
      TempusDominusBootstrap4.prototype._getTimePickerMainTemplate =
        function _getTimePickerMainTemplate() {
          ...
          if (!this.use24Hours) {
            ...
            middleRow.append(
              $("<td>").append(
                $("<btn>").addClass("btn btn-primary").attr({
      ...
      TempusDominusBootstrap4.prototype._getTimePickerTemplate =
        function _getTimePickerTemplate() {
          var hoursView = $("<div>")
      ...
      TempusDominusBootstrap4.prototype._getToolbar = function _getToolbar() {
        var row = [];
        if (this._options.btns.showToday) {
          row.push(
            $("<td>").append(
              $("<a>")
                .attr({
        ...
        if (this._options.btns.showClear) {
          row.push(
            $("<td>").append(
              $("<a>")
                .attr({
        ...
        if (this._options.btns.showClose) {
          row.push(
            $("<td>").append(
              $("<a>")
                .attr({
      ...
      TempusDominusBootstrap4.prototype._updateMonths =
        function _updateMonths() {
          ...
          monthsViewHeader
            .eq(1)
            .attr("title", this._options.tooltips.selectYear);
          monthsViewHeader
            .eq(2)
            .find("span")
      ...
      TempusDominusBootstrap4.prototype._getStartEndYear =
        function _getStartEndYear(factor, year) {
          var step = factor / 10,
      ...
      TempusDominusBootstrap4.prototype._doAction = function _doAction(
        e,
        action
      ) {
      ...
      TempusDominusBootstrap4.prototype.toolbarPlacement =
      ...
      TempusDominusBootstrap4.prototype.widgetPositioning =
        function widgetPositioning(_widgetPositioning) {
          if (arguments.length === 0) {
      ...
      TempusDominusBootstrap4.prototype.widgetParent = function widgetParent(
        _widgetParent
      ) {
        if (arguments.length === 0) {
